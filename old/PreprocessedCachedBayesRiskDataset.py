...
class PreprocessedCachedBayesRiskDataset(Dataset):
    '''
    ...
    '''
    def __init__(self, data, ref_table, split, feature_names, chunk_size=4096*4):
        super().__init__()
    ...
    def load_chunk(self, start_id, end_id):
        ...
        temp_features = {
            feature_name: self.preloaded_data[feature_name].to_numpy() for feature_name in
            self.feature_names
        }
